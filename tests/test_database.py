# tests/test_database.py (mypy‑clean, final)
...
class TestSaveScan:
    ...
    def test_save_with_ai_summary(self) -> None:
        ...
        assert scan_id is not None  # narrow type
...
class TestCompareScans:
    def test_both_existing(self) -> None:
        ...
        assert s1 is not None and s2 is not None  # narrow types
    ...
    def test_one_missing_scan(self) -> None:
        ...
        assert s1 is not None  # narrow type
